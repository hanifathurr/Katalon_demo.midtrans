...
WebUI.click(findTestObject('Payment Checkout/OctoClicks/button_Back'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Payment Checkout/OctoClicks/select_OctoClicks'), 0)
