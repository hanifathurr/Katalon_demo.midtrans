...
WebUI.setText(findTestObject('Payment Checkout/OctoClicks/field_AccountID'), 'testuser00')

WebUI.click(findTestObject('Payment Checkout/OctoClicks/button_Bayar'))

WebUI.verifyElementPresent(findTestObject('Payment Checkout/OctoClicks/transactionSuccess'), 0)

WebUI.click(findTestObject('Payment Checkout/OctoClicks/button_BackToHome'))
