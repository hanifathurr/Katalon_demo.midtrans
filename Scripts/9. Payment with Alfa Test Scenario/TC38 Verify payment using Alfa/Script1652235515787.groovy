...
WebUI.click(findTestObject('Payment Checkout/Alfa/select_Alfa'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('Payment Checkout/Alfa/text_PaymentCode'))

WebUI.verifyElementVisible(findTestObject('Payment Checkout/Alfa/img_Barcode'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Payment Checkout/Alfa/button_ClosePage'), FailureHandling.STOP_ON_FAILURE)
