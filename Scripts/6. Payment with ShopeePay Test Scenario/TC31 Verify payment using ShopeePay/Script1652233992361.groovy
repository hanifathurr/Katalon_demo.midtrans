...
WebUI.click(findTestObject('Payment Checkout/ShopeePay/select_Shopeepay'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('Payment Checkout/ShopeePay/img_QRcode'))

WebUI.click(findTestObject('Payment Checkout/ShopeePay/button_ihavepaid'), FailureHandling.STOP_ON_FAILURE)
