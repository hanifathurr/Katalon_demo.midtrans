...
WebUI.click(findTestObject('Payment Checkout/Debit-CC/radio_PromoRp10'))

WebUI.click(findTestObject('Payment Checkout/Debit-CC/button_PayNow'))

WebUI.verifyElementText(findTestObject('Payment Checkout/Debit-CC/Issuing Credit Card/text_amount'), '19990.00')
