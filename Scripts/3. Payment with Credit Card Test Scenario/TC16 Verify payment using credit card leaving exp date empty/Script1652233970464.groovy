...
WebUI.setText(findTestObject('Payment Checkout/Debit-CC/field_ExpirationDate'), '')
...
WebUI.verifyElementPresent(findTestObject('Payment Checkout/Debit-CC/error_InvalidExpDate'), 0)
