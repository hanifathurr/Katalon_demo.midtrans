...
WebUI.setText(findTestObject('Payment Checkout/Debit-CC/field_CVV'), '')
...
WebUI.verifyElementPresent(findTestObject('Payment Checkout/Debit-CC/error_InvalidCVV'), 0)
