...
WebUI.setText(findTestObject('Payment Checkout/Debit-CC/field_CardNumber'), '')
...
WebUI.verifyElementPresent(findTestObject('Payment Checkout/Debit-CC/error_CardNumber'), 0)
