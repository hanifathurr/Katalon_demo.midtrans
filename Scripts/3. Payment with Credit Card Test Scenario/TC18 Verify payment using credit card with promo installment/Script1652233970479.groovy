...
WebUI.click(findTestObject('Payment Checkout/Debit-CC/radio_PromoInstallment'))

WebUI.click(findTestObject('Payment Checkout/Debit-CC/button_PayNow'))

WebUI.verifyElementText(findTestObject('Payment Checkout/Debit-CC/Issuing Credit Card/text_amount'), '15000.00')
