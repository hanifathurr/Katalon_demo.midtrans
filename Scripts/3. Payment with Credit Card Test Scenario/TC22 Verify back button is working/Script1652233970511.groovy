...
WebUI.click(findTestObject('Payment Checkout/Debit-CC/icon_Back'))

WebUI.click(findTestObject('Payment Checkout/Debit-CC/button_Yes,Cancel'))

WebUI.verifyElementPresent(findTestObject('Payment Checkout/Debit-CC/select_DebitCC'), 0)
