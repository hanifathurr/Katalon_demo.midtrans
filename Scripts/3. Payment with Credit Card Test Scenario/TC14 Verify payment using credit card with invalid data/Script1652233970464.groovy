...
WebUI.setText(findTestObject('Payment Checkout/Debit-CC/field_CardNumber'), GlobalVariable.InvalidCC)
...
WebUI.click(findTestObject('Payment Checkout/Debit-CC/radio_withoutPromo'))
...
WebUI.verifyElementPresent(findTestObject('Payment Checkout/Debit-CC/error_CardDecline'), 0)
