...
WebUI.click(findTestObject('Payment Checkout/Gopay/select_Gopay'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('Payment Checkout/Gopay/img_QRcode'))

WebUI.click(findTestObject('Payment Checkout/Gopay/button_ihavepaid'), FailureHandling.STOP_ON_FAILURE)
