...
WebUI.click(findTestObject('Payment Checkout/BankTransfer/Mandiri/select_Mandiri'))

WebUI.verifyElementPresent(findTestObject('Payment Checkout/BankTransfer/Mandiri/text_BillingNo'), 0)

WebUI.verifyElementPresent(findTestObject('Payment Checkout/BankTransfer/Mandiri/text_CompanyCode'), 0)

WebUI.click(findTestObject('Payment Checkout/BankTransfer/Mandiri/button_ihavepaid'))
