...
WebUI.click(findTestObject('Payment Checkout/BankTransfer/Permata/select_Permata'))

WebUI.verifyElementPresent(findTestObject('Payment Checkout/BankTransfer/Permata/text_VAnumber'), 0)

WebUI.click(findTestObject('Payment Checkout/BankTransfer/Permata/button_ihavepaid'))
