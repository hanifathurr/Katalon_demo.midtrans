...
WebUI.click(findTestObject('Payment Checkout/BankTransfer/Other Bank/select_OtherBank'))

WebUI.verifyElementPresent(findTestObject('Payment Checkout/BankTransfer/Other Bank/text_BankCode'), 0)

WebUI.verifyElementPresent(findTestObject('Payment Checkout/BankTransfer/Other Bank/text_VAnumber'), 0)

WebUI.click(findTestObject('Payment Checkout/BankTransfer/Other Bank/button_ihavepaid'))
