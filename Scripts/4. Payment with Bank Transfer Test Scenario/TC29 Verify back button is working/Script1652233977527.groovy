...
WebUI.click(findTestObject('Payment Checkout/BankTransfer/button_Back'))

WebUI.verifyElementPresent(findTestObject('Payment Checkout/BankTransfer/select_BankTransfer'), 0)
