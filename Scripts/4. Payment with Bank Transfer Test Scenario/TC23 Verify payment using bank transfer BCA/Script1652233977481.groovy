...
WebUI.click(findTestObject('Payment Checkout/BankTransfer/BCA/select_BCA'))

WebUI.verifyElementPresent(findTestObject('Payment Checkout/BankTransfer/BCA/text_VAnumber'), 0)

WebUI.click(findTestObject('Payment Checkout/BankTransfer/BCA/button_ihavepaid'))
