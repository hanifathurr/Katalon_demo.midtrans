...
WebUI.click(findTestObject('Payment Checkout/BankTransfer/BNI/select_BNI'))

WebUI.verifyElementPresent(findTestObject('Payment Checkout/BankTransfer/BNI/text_VANo'), 0)

WebUI.click(findTestObject('Payment Checkout/BankTransfer/BNI/button_ihavepaid'))
