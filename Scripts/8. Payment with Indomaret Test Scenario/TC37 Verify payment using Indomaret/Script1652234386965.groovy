...
WebUI.click(findTestObject('Payment Checkout/Indomaret/select_Indomaret'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('Payment Checkout/Indomaret/text_PaymentCode'))

WebUI.verifyElementVisible(findTestObject('Payment Checkout/Indomaret/img_Barcode'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Payment Checkout/Indomaret/button_ClosePage'), FailureHandling.STOP_ON_FAILURE)
