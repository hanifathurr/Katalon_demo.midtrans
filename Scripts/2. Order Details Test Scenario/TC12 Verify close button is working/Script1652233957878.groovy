...
WebUI.click(findTestObject('Payment Checkout/button_Close'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Home Page/body_HomePage'), 0)
