...
WebUI.click(findTestObject('Order Details/tab_OrderDetails'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Order Details/text_Nama'), GlobalVariable.Name)

WebUI.verifyElementText(findTestObject('Order Details/text_NoTelp'), GlobalVariable.Phone)
