...
WebUI.setText(findTestObject('Payment Checkout/Akulaku/field_PhoneNumber'), '081290309353')

WebUI.click(findTestObject('Payment Checkout/Akulaku/button_Next'))

WebUI.verifyElementPresent(findTestObject('Payment Checkout/Akulaku/error_InvalidPhoneNumber'), 0)
