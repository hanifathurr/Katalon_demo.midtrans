...
WebUI.click(findTestObject('Payment Checkout/Akulaku/button_Back'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Payment Checkout/Akulaku/button_Yes Cancel'))

WebUI.verifyElementPresent(findTestObject('Payment Checkout/Akulaku/select_Akulaku'), 0)
